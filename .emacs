...
(custom-set-faces
 ...
 '(rainbow-delimiters-depth-1-face ((((background dark)) (:foreground "red" :height 1.8))))
 '(rainbow-delimiters-depth-2-face ((((background dark)) (:foreground "orange" :height 1.7))))
 '(rainbow-delimiters-depth-3-face ((((background dark)) (:foreground "yellow" :height 1.6))))
 '(rainbow-delimiters-depth-4-face ((((background dark)) (:foreground "#55FF55" :height 1.5))))
 '(rainbow-delimiters-depth-5-face ((((background dark)) (:foreground "cyan" :height 1.4))))
 '(rainbow-delimiters-depth-6-face ((((background dark)) (:foreground "#2F2FFF" :height 1.3))))
 '(rainbow-delimiters-depth-7-face ((((background dark)) (:foreground "purple" :height 1.2))))
 '(rainbow-delimiters-depth-8-face ((((background dark)) (:foreground "#a2b6da" :height 1.1))))
