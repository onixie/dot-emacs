...
;;; History:
;;
;; Tue Jan 11 11:08:42 JST 2011 (nixie): prevent null reference of
;; buffer-display-table in tab-display-hide.
;;
...
(defun tab-display-hide()
  ...
  (if (not (null buffer-display-table))
...
;; (add-hook 'font-lock-mode-hook 'tab-display-mode-hook) ;; This should be done by customization.
