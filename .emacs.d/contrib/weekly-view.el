...
;; Copyright (C) 2003, 2011 Doug Alcorn <doug@lathi.net>
...
;; version 3: patch from Nixie <onixie@gmail.com> fix for Emacs v23.1
...
See `diary-view-entries' for more."
  (interactive)
  (save-excursion
...
(defvar weekly-graph-day-start  830
  "Time to start each day's view in military style integers (i.e. \"8:30am\" is 830)")
(defvar weekly-graph-day-end 1800
  "Time to end each day's view in military style integers (i.e. \"18:00\" is 1800)")
(defvar weekly-graph-increment 30
  "Increment in minutes for each row on the weekly graph of diary entries")
(defvar weekly-graph-use-hash-marks nil
