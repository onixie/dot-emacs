...
(defun dot-emacs::override-centaur-tabs-project-name (orig-fun &rest args)
  (let ((res (apply orig-fun args)))
    (replace-regexp-in-string "Project:.*/\\(.*\\)/" "Project: \\1" res)))

(advice-add 'centaur-tabs-project-name :around #'dot-emacs::override-centaur-tabs-project-name)

(defun dot-emacs::override-centaur-tabs-buffer-groups (orig-fun &rest args)
  (list
   (cond
...
(advice-add 'centaur-tabs-buffer-groups :around #'dot-emacs::override-centaur-tabs-buffer-groups)

(defun dot-emacs::override-centaur-tabs-hide-tab (orig-fun &rest args)
...
(advice-add 'centaur-tabs-hide-tab :around #'dot-emacs::override-centaur-tabs-hide-tab)
